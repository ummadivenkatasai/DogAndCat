...
function Signup() {
    ...
    async function generateOtp(name){
        ...
        const existingMobileNumber = await axios.post(`${import.meta.env.VITE_API_URL}/api/mobileNumber`,{mobileNumber});
        const existingEmail = await axios.post(`${import.meta.env.VITE_API_URL}/api/email`,{email});
